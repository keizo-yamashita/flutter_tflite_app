...
const List<String> displayYoloLabels = [
...
const List<String> displayMobileNetLabels = [
  ...
  '???','book','clock','vase','scissors','teddy bear','hair drier','toothbrus',
];

class Recognition {
  Recognition(this._id, this._labelId, this._score, this._location, this._isYolo);
  final int _id;
  int get id => _id;
  final int _labelId;
  int get label => _labelId;
  final bool _isYolo;
  bool get isYolo => _isYolo;
  String get displayLabel => _isYolo ? displayYoloLabels[_labelId] : displayMobileNetLabels[_labelId];
  final double _score;
